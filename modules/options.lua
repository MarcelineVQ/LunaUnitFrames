...
function LunaUF:LoadOptions()
	...
	if LunaOptionsFrame.pages[page].seventhbuff then LunaOptionsFrame.pages[page].seventhbuff:SetText(LunaUF.db.profile.units.raid.squares.buffs.names[7]) end
	LunaOptionsFrame.pages[page].seventhbuffcolor.load(LunaOptionsFrame.pages[page].seventhbuffcolor,LunaUF.db.profile.units.raid.squares.buffs.colors[7])
	if LunaOptionsFrame.pages[page].eightbuff then LunaOptionsFrame.pages[page].eightbuff:SetText(LunaUF.db.profile.units.raid.squares.buffs.names[8]) end
	LunaOptionsFrame.pages[page].eightbuffcolor.load(LunaOptionsFrame.pages[page].eightbuffcolor,LunaUF.db.profile.units.raid.squares.buffs.colors[8])
...
function LunaUF:CreateOptionsMenu()
	...
	LunaOptionsFrame.pages[page].fourthbuff:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].thirdbuff, "BOTTOMLEFT", 0, -5)
	LunaOptionsFrame.pages[page].fourthbuff:SetScript("OnTextChanged", function()
		...
		for _,frame in pairs(LunaUF.Units.frameList) do	if frame.unitGroup == "raid" then LunaUF.Units.FullUpdate(frame) end end end)
	...
	LunaOptionsFrame.pages[page].fifthbuff:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].fourthbuff, "BOTTOMLEFT", 0, -5)
	...
	-- 6th extra buff
	LunaOptionsFrame.pages[page].sixthbuff = CreateFrame("Editbox", "SixthBuffInput", LunaOptionsFrame.pages[page], "InputBoxTemplate")
	...
	LunaOptionsFrame.pages[page].sixthbuff:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].fifthbuff, "BOTTOMLEFT", 0, -5)
	...
	-- 7th extra buff
	LunaOptionsFrame.pages[page].seventhbuff = CreateFrame("Editbox", "SeventhBuffInput", LunaOptionsFrame.pages[page], "InputBoxTemplate")
	LunaOptionsFrame.pages[page].seventhbuff:SetHeight(20)
	LunaOptionsFrame.pages[page].seventhbuff:SetWidth(200)
	LunaOptionsFrame.pages[page].seventhbuff:SetAutoFocus(nil)
	LunaOptionsFrame.pages[page].seventhbuff:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].sixthbuff, "BOTTOMLEFT", 0, -5)
	LunaOptionsFrame.pages[page].seventhbuff:SetScript("OnTextChanged", function()
		LunaUF.db.profile.units.raid.squares.buffs.names[7] = this:GetText()
		for _,frame in pairs(LunaUF.Units.frameList) do	if frame.unitGroup == "raid" then LunaUF.Units.FullUpdate(frame) end end end)
	LunaOptionsFrame.pages[page].seventhbuff:SetScript("OnEscapePressed", Exit)
	LunaOptionsFrame.pages[page].seventhbuff:SetScript("OnEnterPressed", Exit)
		LunaOptionsFrame.pages[page].seventhbuffcolor = CreateColorSelect(LunaOptionsFrame.pages[page], LunaUF.db.profile.units.raid.squares.buffs.colors[7])
		LunaOptionsFrame.pages[page].seventhbuffcolor:SetPoint("LEFT", LunaOptionsFrame.pages[page].seventhbuff, "RIGHT", 10, 0)
		LunaOptionsFrame.pages[page].seventhbuffcolor:SetHeight(19)
		LunaOptionsFrame.pages[page].seventhbuffcolor:SetWidth(19)
		LunaOptionsFrame.pages[page].seventhbuffcolor.text:SetText(L["Buffcolor"])
	LunaOptionsFrame.pages[page].seventhbuffinvert = CreateFrame("CheckButton", "SeventhBuffInvert", LunaOptionsFrame.pages[page], "UICheckButtonTemplate")
	LunaOptionsFrame.pages[page].seventhbuffinvert:SetPoint("LEFT", LunaOptionsFrame.pages[page].seventhbuffcolor, "RIGHT", 70, 0)
	LunaOptionsFrame.pages[page].seventhbuffinvert:SetHeight(15)
	LunaOptionsFrame.pages[page].seventhbuffinvert:SetWidth(15)
	LunaOptionsFrame.pages[page].seventhbuffinvert:SetScript("OnClick", function()
		LunaUF.db.profile.units.raid.squares.invertseventhbuff = not LunaUF.db.profile.units.raid.squares.invertseventhbuff
		for _,frame in pairs(LunaUF.Units.frameList) do if frame.unitGroup == "raid" then LunaUF.Units.FullUpdate(frame) end end end)
	getglobal("SeventhBuffInvertText"):SetText(L["Invert display"])

	-- 8th extra buff
	LunaOptionsFrame.pages[page].eightbuff = CreateFrame("Editbox", "EightBuffInput", LunaOptionsFrame.pages[page], "InputBoxTemplate")
	LunaOptionsFrame.pages[page].eightbuff:SetHeight(20)
	LunaOptionsFrame.pages[page].eightbuff:SetWidth(200)
	LunaOptionsFrame.pages[page].eightbuff:SetAutoFocus(nil)
	LunaOptionsFrame.pages[page].eightbuff:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].seventhbuff, "BOTTOMLEFT", 0, -5)
	LunaOptionsFrame.pages[page].eightbuff:SetScript("OnTextChanged", function()
		LunaUF.db.profile.units.raid.squares.buffs.names[8] = this:GetText()
		for _,frame in pairs(LunaUF.Units.frameList) do	if frame.unitGroup == "raid" then LunaUF.Units.FullUpdate(frame) end end end)
	LunaOptionsFrame.pages[page].eightbuff:SetScript("OnEscapePressed", Exit)
	LunaOptionsFrame.pages[page].eightbuff:SetScript("OnEnterPressed", Exit)
		LunaOptionsFrame.pages[page].eightbuffcolor = CreateColorSelect(LunaOptionsFrame.pages[page], LunaUF.db.profile.units.raid.squares.buffs.colors[8])
		LunaOptionsFrame.pages[page].eightbuffcolor:SetPoint("LEFT", LunaOptionsFrame.pages[page].eightbuff, "RIGHT", 10, 0)
		LunaOptionsFrame.pages[page].eightbuffcolor:SetHeight(19)
		LunaOptionsFrame.pages[page].eightbuffcolor:SetWidth(19)
		LunaOptionsFrame.pages[page].eightbuffcolor.text:SetText(L["Buffcolor"])
	LunaOptionsFrame.pages[page].eightbuffinvert = CreateFrame("CheckButton", "EightBuffInvert", LunaOptionsFrame.pages[page], "UICheckButtonTemplate")
	LunaOptionsFrame.pages[page].eightbuffinvert:SetPoint("LEFT", LunaOptionsFrame.pages[page].eightbuffcolor, "RIGHT", 70, 0)
	LunaOptionsFrame.pages[page].eightbuffinvert:SetHeight(15)
	LunaOptionsFrame.pages[page].eightbuffinvert:SetWidth(15)
	LunaOptionsFrame.pages[page].eightbuffinvert:SetScript("OnClick", function()
		LunaUF.db.profile.units.raid.squares.inverteightbuff = not LunaUF.db.profile.units.raid.squares.inverteightbuff
		for _,frame in pairs(LunaUF.Units.frameList) do if frame.unitGroup == "raid" then LunaUF.Units.FullUpdate(frame) end end end)
	getglobal("EightBuffInvertText"):SetText(L["Invert display"])

	-- debuffs
	LunaOptionsFrame.pages[page].debuffheader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY", "GameFontHighlightSmall")
	LunaOptionsFrame.pages[page].debuffheader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].eightbuff, "BOTTOMLEFT", 0, -10)
